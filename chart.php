...
// Ambil batas kategori dari DB
$batas_query = mysqli_query($conn, "SELECT nama_kategori, batas FROM kategori_batas");
$limits = [];
...
$query = mysqli_query($conn, "SELECT kategori, SUM(nominal) as total_pengeluaran FROM uang_keluar GROUP BY kategori");
$categories = [];
$expenses = [];
